<?php 
//habilitando las variables de session por usuarios
session_start();
include './php/conexion.php'; // se requiere el archivo de conexion
if (isset($_SESSION['carrito'])) {
    //si existe se busca si ya esta agregado el producto
    if (isset($_GET['id'])) {
 ...
 //si no se crea la variable de session
 if (isset($_GET['id'])){
   $nombre ="";
   $precio ="";
   $imagen ="";
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row mb-5">
                  <div class="col-md-6">
                    <span class="text-black">Total + Iva</span>
                  </div>
                  <div class="col-md-6 text-right">
                    <strong class="text-black">$<?php echo $total*0.16; ?></strong>
                  </div>
                </div>
